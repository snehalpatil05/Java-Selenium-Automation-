...
public class SelectTheVisibleText {
...
//		select.selectByVisibleText("Android"); // selectByVisibleText() looks for the Hardcoded visible value or the Inner text of the tag
		select.selectByContainsVisibleText("Backup");  // we can give partial text
